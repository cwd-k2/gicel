	...
	modExports := &ModuleExports{
		...
		ConTypes: map[string]types.Type{
			"Just": &types.TyForall{
				...
				Body: testOps.Arrow(&types.TyVar{Name: "a"}, &types.TyApp{
					Fun: testOps.Con("Maybe"),
...
func TestProbeA_Ambiguity_TwoOpenImportsSameName(t *testing.T) {
	modA := &ModuleExports{
		...
		Aliases:         map[string]*AliasInfo{},
		Classes:         map[string]*ClassInfo{},
		Values:          map[string]types.Type{"foo": testOps.Con("Int")},
		PromotedKinds:   map[string]types.Type{},
		PromotedCons:    map[string]types.Type{},
		TypeFamilies:    map[string]*TypeFamilyInfo{},
		ModuleOwnership: ModuleOwnership{
	...
	modB := &ModuleExports{
		...
		Aliases:         map[string]*AliasInfo{},
		Classes:         map[string]*ClassInfo{},
		Values:          map[string]types.Type{"foo": testOps.Con("String")},
		PromotedKinds:   map[string]types.Type{},
		PromotedCons:    map[string]types.Type{},
		TypeFamilies:    map[string]*TypeFamilyInfo{},
		ModuleOwnership: ModuleOwnership{
...
func TestProbeA_Ambiguity_TwoOpenImportsSameConstructor(t *testing.T) {
	makeModWithCon := func(typeName string) *ModuleExports {
		...
		return &ModuleExports{
			Types:           map[string]types.Type{typeName: types.TypeOfTypes},
			ConTypes:        map[string]types.Type{"MkVal": testOps.Con(typeName)},
...
func TestProbeD_Module_QualifiedVarLookup(t *testing.T) {
	modExports := &ModuleExports{
		...
		Aliases:         map[string]*AliasInfo{},
		Classes:         map[string]*ClassInfo{},
		Values:          map[string]types.Type{"add": testOps.Arrow(testOps.Con("Int"), testOps.Arrow(testOps.Con("Int"), testOps.Con("Int")))},
		PromotedKinds:   map[string]types.Type{},
		PromotedCons:    map[string]types.Type{},
		TypeFamilies:    map[string]*TypeFamilyInfo{},
	}
...
func TestProbeD_Module_QualifiedShadowLocal(t *testing.T) {
	modExports := &ModuleExports{
		...
		Aliases:         map[string]*AliasInfo{},
		Classes:         map[string]*ClassInfo{},
		Values:          map[string]types.Type{"val": testOps.Con("Int")},
		PromotedKinds:   map[string]types.Type{},
		PromotedCons:    map[string]types.Type{},
		TypeFamilies:    map[string]*TypeFamilyInfo{},
	}
