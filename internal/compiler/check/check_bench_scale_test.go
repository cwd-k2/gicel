...
func doBlockSource(n int) string {
	...
	b.WriteString("form GradeAlgebra := \\(g: Kind). { type GradeJoin :: g -> g -> g; type GradeCompose :: g -> g -> g; type GradeDrop :: g }\n")
	b.WriteString("impl GradeAlgebra Trivial := { type GradeJoin := TrivialJoin; type GradeCompose := TrivialCompose; type GradeDrop := Triv }\n")
