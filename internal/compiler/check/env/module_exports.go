...
type ModuleExports struct {
	Types           map[string]types.Type      // registered type constructors
	...
	PromotedKinds   map[string]types.Type      // DataKinds promotions
	PromotedCons    map[string]types.Type      // promoted constructors
