...
`
	...
	cases := []struct {
		...
		{"SetStepLimit", func(e *Engine) { e.SetStepLimit(e.runtimeLimits.stepLimit + 1) }},
		{"SetDepthLimit", func(e *Engine) { e.SetDepthLimit(e.runtimeLimits.depthLimit + 1) }},
		{"SetNestingLimit", func(e *Engine) { e.SetNestingLimit(e.compilerLimits.nestingLimit + 1) }},
		{"SetAllocLimit", func(e *Engine) { e.SetAllocLimit(123_456) }},
		{"SetMaxTFSteps", func(e *Engine) { e.SetMaxTFSteps(e.compilerLimits.maxTFSteps + 1) }},
		{"SetMaxSolverSteps", func(e *Engine) { e.SetMaxSolverSteps(e.compilerLimits.maxSolverSteps + 1) }},
		{"SetMaxResolveDepth", func(e *Engine) { e.SetMaxResolveDepth(e.compilerLimits.maxResolveDepth + 1) }},
