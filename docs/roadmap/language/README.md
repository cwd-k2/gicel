...
```
  ...
  GIMonad: per-computation grade → IxMonad の graded 拡張
...
- **GIMonad** (仮名): IxMonad の graded 拡張。per-computation grade を統合。設計確定、実装未着手。[infrastructure.md](infrastructure.md) 参照。
