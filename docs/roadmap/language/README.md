...
```
  ...
  Infrastructure Path               Universe / SMC
  ────────────────────               ──────────────
  ✓ L0-b: Universe                   ✓ Non-nullary promotion
  ✓ L1: Solver + Equality            Univ polymorphism
  ✓ L2-b: Grade errors               Cumulativity
  ✓ L3: Grade algebra
  ✓ Row TF: Merge

  ┌──────────────┐
  │ SMC Phase 2  │   (><: internal row merge)
  │ SMC Phase 3  │   (dag: pre/post swap)
  └──────┬───────┘
         │
  ┌──────┴────────────────────────────────────────────┐
  │ 応用層 (並行可能)                                 │
...
**Infrastructure**: ~~L0-b~~ → ~~L1~~ → ~~L2-b~~ → ~~L3~~ → ~~Row TF: Merge~~ → ~~Non-nullary promotion~~ 完了。

次の着手候補: SMC Phase 2/3、Named capabilities、Universe polymorphism。
